package me.day20.generic.multitype;


import me.day20.generic.multitype.product.Product;
import me.day20.generic.multitype.product.ProductMap;
import me.day20.generic.multitype.product.SmartPhone;
import me.day20.generic.multitype.product.Tablet;

public class GenericMultiTypeExample {
    public static void main(String[] args) {

        ProductMap<String, Product> productMap1 = new ProductMap<>();
        productMap1.put("0001", new SmartPhone("Z-FLIP", "SAMSUNG", 20, 3));
        ...
        productMap2.put(1, new SmartPhone("Z-FLIP", "SAMSUNG", 20, 3));
