...
public class WriterWriteExample2 {
    static final String path = FileUtil.getOutPath( WriterWriteExample2.class );
    static final String filename = "output.txt";
    public static void main(String[] args) {
        final char[] data = "가 나 다 라 마 바 사 아".toCharArray(); // 자바에서 한글 지원하기 때문에 (유니코드) 깨지지 않음
//      final char[] data = "a b c d e f g h i j k".toCharArray(); // "a b c d e f g h i j k"을 한꺼번에 출력
