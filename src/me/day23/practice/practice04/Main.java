package me.day23.practice.practice04;
...
public class Main {
    public static void main(String[] args) throws IOException {
        final String path = Main.class.getResource("").getPath();
        ...
        try (
                Reader fr = new FileReader(path + fileName);
                BufferedReader br = new BufferedReader(fr);

                Writer fw = new FileWriter(path + copyFileName);
