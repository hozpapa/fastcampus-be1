package me.day24.logging;

import java.util.logging.Level;
import java.util.logging.Logger;

public class LoggingExample2 {
    private static Logger logger = Logger.getLogger(LoggingExample2.class.getName()); // root logger
    public static void main(String[] args) {
        // 특정 Level 이상의 로그들만 출력하도록 설정
        logger.setLevel(Level.WARNING); // root logger level set (INFO => WARNING)
